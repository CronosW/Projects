...
void Laborator7::Init()
{
	...
	//Light & material properties
	{
		...
		materialKd = glm::vec3(0.5f, 0.5f, 0.5f);
		materialKs = glm::vec3(0, 0.5f, 0.5f);
	}
}
...
void Laborator7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
	...
	glUniform3f(glGetUniformLocation(shader->program, "material_kd"), materialKd.x, materialKd.y, materialKd.z);
	glUniform3f(glGetUniformLocation(shader->program, "material_ks"), materialKs.x, materialKs.y, materialKs.z);
