...
{
	{
		...
		RenderSimpleMesh(meshes["sphere"], shaders["ShaderLab9"], modelMatrix, mapTextures["earth"], NULL, 3.0f);
	}

	{
		...
		RenderSimpleMesh(meshes["box"], shaders["ShaderLab9"], modelMatrix, mapTextures["crate"], NULL, 5.0f);
	}

	{
		...
		RenderSimpleMesh(meshes["box"], shaders["ShaderLab9"], modelMatrix, mapTextures["random"], NULL, 2.0f);
	}

	{
		...
		RenderSimpleMesh(meshes["square"], shaders["ShaderLab9"], modelMatrix, mapTextures["grass"], NULL, 4.0f);
	}

	{
		...
		RenderSimpleMesh(meshes["bamboo"], shaders["ShaderLab9"], modelMatrix, mapTextures["bamboo"], NULL, 1.0f);
	}
}
...
void Laborator9::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, Texture2D* texture1, Texture2D* texture2, float useAlpha)
{
	...
	if (texture2)
	{
		...
		glUniform1i(glGetUniformLocation(shader->program, "texture_2"), i);
	}
	glUniform1f(glGetUniformLocation(shader->program, "useAlpha"), useAlpha);
